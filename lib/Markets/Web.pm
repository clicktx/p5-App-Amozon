...
sub dispatch {
    return (Markets::Web::Dispatcher->dispatch($_[0]) or die "response is not generated");
}
...
{
    sub create_view {
        my $view = Markets::Web::View->make_instance(__PACKAGE__);
        no warnings 'redefine';
        *Markets::Web::create_view = sub { $view }; # Class cache.
        $view
    }
}
