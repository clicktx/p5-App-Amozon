...
sub dispatch {
    return (
        Amozon::Admin::Dispatcher->dispatch( $_[0] )
...
use Amozon::Admin::View;
{
    ...
    sub create_view {
        my $view = Amozon::Admin::View->make_instance(__PACKAGE__);
        no warnings 'redefine';
        *Amozon::Admin::create_view = sub { $view };    # Class cache.
        $view;
    }
}
